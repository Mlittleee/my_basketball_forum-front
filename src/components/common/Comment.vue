...
.my-reply .my-reply-input:focus{
  border: 1px solid #ccc;
}
.my-reply .my-reply-input::placeholder{
  color: #ccc;
}
.my-reply .my-reply-btn{
  width: 60px;
  height: 40px;
  border-radius: 20px;
...
.reply-comment .reply-comment-input{
  width: 100%;
  height: 40px;
  border-radius: 20px;
  border: 1px solid #ccc;
...
.reply-comment .reply-comment-input:focus{
  border: 1px solid #ccc;
}
.reply-comment .reply-comment-input::placeholder{
  color: #ccc;
}
...
.reply-comment .reply-comment-btn:hover{
  background-color: #999;
}
.reply-comment .reply-comment-btn:active{
